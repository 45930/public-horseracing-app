...
--     ROUND(s.turf_eps, 4) AS turf_eps,
--     ROUND(s.turf_win_factor, 4) AS turf_win_factor,
--     ROUND(s.distance_eps, 4) AS distance_eps,
--     ROUND(s.distance_win_factor, 4) AS distance_win_factor,
--     ROUND(s.track_eps, 4) AS track_eps,
--     ROUND(s.track_win_factor, 4) AS track_win_factor,
--     ROUND(s.fast_dirt_eps, 4) AS fast_dirt_eps,
--     ROUND(s.fast_dirt_win_factor, 4) AS fast_dirt_win_factor,
...
--   ra.purse,
--   ra.classification,
--   ROUND(c.distance, 0) AS distance,
--   c.track_code,
--   td.horse_id,
--   td.horse_name,
...
--   td.eps,
--   td.distance_eps,
--   td.distance_win_factor,
--   td.track_eps,
--   td.track_win_factor,
--   td.win_rate,
--   CASE WHEN c.surface = 'd' THEN
--     td.fast_dirt_eps
--   ELSE
--     0
--   END AS fast_dirt_eps,
--   CASE WHEN c.surface = 'd' THEN
--     td.fast_dirt_win_factor
--   ELSE
--     0
--   END AS fast_dirt_win_factor,
...
--   WHERE
--     td.field_size > 4
--     AND td.field_size < 11
--     AND sq.min_starts > 0
--     AND c.distance >= 5
--     AND c.distance <= 12
--     AND td.post_position >= 1
--     AND td.post_position < 11
--   ORDER BY
--     td.race_id ASC,
